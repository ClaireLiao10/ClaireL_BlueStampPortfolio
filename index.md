...
-->
# First Milestone
Since the Ultrasonic sensor helps detect the distance between an incoming object, my project needed the Ultrasonic sensor. My first milestone was to connect and test the Ultrasonic sensor to my serial monitor. During the last two days, I have finished wiring and uploading the necessary code onto the serial monitor. So far my project has gone really smoothly and there were no big challenges that I have to face at this time. My plan after this to add in the motors and incorporate the Ultrasonic sensor into the motor.
**Don't forget to replace the text below with the embedding for your milestone video. Go to Youtube, click Share -> Embed, and copy and paste the code to replace what's below.**
